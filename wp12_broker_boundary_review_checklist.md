...
- [ ] Off-lead inventory triggers roll/flatten planning from current positions.
...
- [ ] WP12 output can be consumed later by WP13 without changing the `order_intents` contract.
